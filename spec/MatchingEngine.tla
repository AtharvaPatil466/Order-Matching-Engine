...
(* four actions: PlaceLimit, CancelOrder, ExpireGTD, AdvanceTime.          *)
...
(*   - There is NO matching/cross action: resting orders never execute     *)
(*     against each other (see docs/Verification.md, "No matching in       *)
(*     the spec"). The spec proves book-management safety, not             *)
